...
import flab.project.jobfinder.dto.JobKoreaDetailedSearchDto;
...
class JobKoreaCrawlerServiceTest {
    ...
    @Test
    void 크롤링_정상_작동_테스트() {
        DetailedSearchDto dto = JobKoreaDetailedSearchDto.builder().searchText("spring").build();
    ...
    @Nested
    @DisplayName("toQueryParams 메서드 테스트")
    class toQueryParamsTest {

        private Stream<Arguments> provideDto() {
            return Stream.of(
                    Arguments.of(JobKoreaDetailedSearchDto.builder().build(), ""),
                    Arguments.of(JobKoreaDetailedSearchDto.builder().searchText("spring").build(), "stext=spring"),
                    Arguments.of(JobKoreaDetailedSearchDto.builder().searchText("spring boot")
                            .career(new DetailedSearchDto.Career(JUNIOR, null, "2")).build()
                            , "stext=spring+boot&careerType=1&careerMax=2"),
                    Arguments.of(JobKoreaDetailedSearchDto.builder().searchText("웹 서비스")
                    ...
                    Arguments.of(JobKoreaDetailedSearchDto.builder().searchText("react 웹 프런트")
        ...
        void 정상_url_리턴(DetailedSearchDto dto, String expected) {
            String result = ReflectionTestUtils.invokeMethod(dto, "toQueryParams");
